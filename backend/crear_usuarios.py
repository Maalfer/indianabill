...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("   • admin_indiana / admin123 (ADMIN)")
        print("   • carlos_admin / admin456 (ADMIN)")
        print("   • juan_usuario / usuario123 (USER)")
        print("   • maria_test / test123 (USER)")
        print("   • ana_cliente / cliente123 (USER)")
